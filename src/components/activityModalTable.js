...
class ActivityModalTable extends React.Component {
    ...
    render() {
        ...
        return ( <div className = "" >
            ...
            <button style={{border: 'none', backgroundColor: 'white', color: 'blue', float: 'right'}} onClick = { this.openModal } > more... </button>  <br / > 
            ...
            <button style={{border: 'none', backgroundColor: 'white', color: 'blue', float: 'right'}} onClick = { this.closeModal } > close </button> 
